...
public class JMHExample23 {
    ...
    public void init() throws URISyntaxException, IOException {
        this.wilsonBytes = Files.readAllBytes(Path.of(JMHExample23.class.getResource("Wilson.class").toURI()));
    ...
    public static void main(String[] args) throws RunnerException {
        new Runner(new OptionsBuilder().include(JMHExample23.class.getSimpleName())
                .addProfiler(ClassloaderProfiler.class).build()).run();
    }
